<?php 
  include_once('../data/admin_session.php'); //Session required for login
  ...
  <nav class="navbar navbar-inverse" style="margin-top:-18px;">
    <div class="container-fluid">
      <ul class="nav navbar-nav">
        <li>
          <a href="item-owned.php"><span class="glyphicon glyphicon-dashboard"></span> Dashboard</a>
        </li>
        ...
        <li class="active">
          <a href="user-report.php"><span class="glyphicon glyphicon-list-alt"></span> Report</a>
        </li>
      </ul>
