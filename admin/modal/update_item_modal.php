				...
				<!-- main form -->
					...
					<input type="hidden" id="iID">
					  <div class="form-group">
					    <label class="control-label col-sm-3" for="itemName-update">IP Address:</label>
					    <div class="col-sm-9">
					  ...
					  <div class="form-group">
					    <label class="control-label col-sm-3" for="serialNumber-update">Hostname:</label>
					    <div class="col-sm-9"> 
					   ...
					   <div class="form-group">
					    <label class="control-label col-sm-3" for="modelNumber-update">Function:</label>
					    <div class="col-sm-9"> 
					  ...
					  <div class="form-group">
					    <label class="control-label col-sm-3" for="brand-update">Storage Capacity</label>
					    <div class="col-sm-9"> 
					  ...
					  <div class="form-group">
					    <label class="control-label col-sm-3" for="amount-update">Memory Capacity:</label>
					    <div class="col-sm-9"> 
					   ...
					   <div class="form-group">
					    <label class="control-label col-sm-3" for="purDate-update">Date:</label>
					    <div class="col-sm-9"> 
